public class Mago extends Personaggio {
    ...
    public Mago(String nome, int puntiVita, int puntiAttacco, int puntiDifesa, int puntiStamina,
            int puntiMovimento, String nomeEquipaggiamento, int potenza, int resistenza, boolean magia, int puntiMagia,
            String animaleAddestrato) {
